...
**71 tools total** across the eleven specs below plus cross-cutting ops (hash attestation, audit-stream events, cross-spec drift) and the DefenseTech tooling. See the [Tools](#tools) catalog above for the full per-tool list (47 spec + 16 implementation-preview + 8 DefenseTech).
